...
public class ApiUtils {
    ...
    // ** JSON으로 반환해야할 데이터.
    @JsonSerialize(using = ApiResultSerializer.class)
    ...
    public static class ApiResultSerializer extends JsonSerializer<ApiResult> {
        @Override
        public void serialize(ApiResult value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
